...
**Repository**: [**AI-Microgrid**](https://github.com/Emon-36/AI-Microgrid)
...
- **Modular, resilient design** for competition
...
- **Compete under pressure** with clarity and confidence
